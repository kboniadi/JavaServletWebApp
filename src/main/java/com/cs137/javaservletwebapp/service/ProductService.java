...
public class ProductService {
    ...
    public List<Product> getProducts() {
        return Arrays.asList(
                ...
                new Product("img/products/La Brique 1.0", "La Brique 1.0", "Motorola", 10.00, 5.0),
                new Product("img/Lime 7 - Pro.png", "Lime 7 - Pro", "Motorola", 30.00, 3.4),
                new Product("img/products/Doro-750-Consumer-Cellular-Phone", "Doro 750", "Doro", 35.00, 3.2));
    }
}
